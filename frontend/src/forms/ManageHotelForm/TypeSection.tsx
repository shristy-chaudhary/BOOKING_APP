    ...
    return(
        <div>
            ...
            <div className="grid grid-cols-5 gap-2">
                {HotelTypes.map((type)=>(
                    <label className={
                        typeWatch === type ? "curosr-pointer bg-blue-300 text-sm rounded-full px-4 py-2 font-semibold": "curosr-pointer bg-gray-300 text-sm rounded-full px-4 py-2 font-semibold"
                    }>
