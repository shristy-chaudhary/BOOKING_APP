    ...
    return(
        <div>
            ...
            <div className="grid grid-cols-2 p-6 gap-5 bg-gray-300">
                ...
                <input className="border rounded w-full py-2 px-3 font-normal"  type="numnber" min = {1} {...register("adultCount", {required:"This field is required"})}/>
                ...
                <input className="border rounded w-full py-2 px-3 font-normal"  type="numnber" min = {0} {...register("childCount", {required:"This field is required"})}/>
